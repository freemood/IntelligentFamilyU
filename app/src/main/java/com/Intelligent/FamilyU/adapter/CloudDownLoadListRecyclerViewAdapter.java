...
public class CloudDownLoadListRecyclerViewAdapter extends RecyclerView.Adapter<CloudDownLoadListRecyclerViewAdapter.ViewHolder> {
    ...
    public CloudDownLoadListRecyclerViewAdapter(Context context, List<CloudFileBean> list, OnItemClickListener onItemClickListener) {
        super();
        mlist = list;
    ...
    @Override
    public CloudDownLoadListRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                              int viewType) {
        // create a new view
        View convertView = LayoutInflater.from(context)
                .inflate(R.layout.listview_files_cloud_download_list_item, parent, false);
