...
public class CloudSearchListRecyclerViewAdapter extends RecyclerView.Adapter<CloudSearchListRecyclerViewAdapter.ViewHolder> {
    ...
    public CloudSearchListRecyclerViewAdapter(Context context, List<CloudStorageFile> list, OnItemClickListener onItemClickListener) {
        super();
        mlist = list;
    ...
    @Override
    public CloudSearchListRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                            int viewType) {
        // create a new view
        View convertView = LayoutInflater.from(context)
                .inflate(R.layout.listview_cloud_search_list_item, parent, false);
