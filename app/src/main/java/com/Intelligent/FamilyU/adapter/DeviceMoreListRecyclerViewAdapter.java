...
public class DeviceMoreListRecyclerViewAdapter extends RecyclerView.Adapter<DeviceMoreListRecyclerViewAdapter.ViewHolder> {
    ...
    public DeviceMoreListRecyclerViewAdapter(Context context, List<HashMap<String, String>> list, OnItemClickListener onItemClickListener) {
        super();
        mlist = list;
    ...
    @Override
    public DeviceMoreListRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                           int viewType) {
        // create a new view
        View convertView = LayoutInflater.from(context)
                .inflate(R.layout.listview_more_device_list_item, parent, false);
