...
public class FileMabagerDoenliadListRecyclerViewAdapter extends RecyclerView.Adapter<FileMabagerDoenliadListRecyclerViewAdapter.ViewHolder> {
    ...
    public FileMabagerDoenliadListRecyclerViewAdapter(Context context, List<HashMap<String, Object>> list, OnItemClickListener onItemClickListener) {
        super();
        mlist = list;
    ...
    @Override
    public FileMabagerDoenliadListRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                                    int viewType) {
        // create a new view
        View convertView = LayoutInflater.from(context)
                .inflate(R.layout.listview_files_download_list_item, parent, false);
