...
public class GatewayDevicePageRecyclerViewAdapter extends RecyclerView.Adapter<GatewayDevicePageRecyclerViewAdapter.ViewHolder> {
    ...
    public GatewayDevicePageRecyclerViewAdapter(Context context, List<HashMap<String, Object>> list, OnItemClickListener onItemClickListener) {
        super();
        mlist = list;
    ...
    @Override
    public GatewayDevicePageRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                              int viewType) {
        // create a new view
        View convertView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.listview_gateway_device_paget_item, parent, false);
