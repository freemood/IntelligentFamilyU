...
public class GatewayPluginListRecyclerViewAdapter extends RecyclerView.Adapter<GatewayPluginListRecyclerViewAdapter.ViewHolder> {
    ...
    public GatewayPluginListRecyclerViewAdapter(Context context, List<HashMap<String, Object>> list, OnItemClickListener onItemClickListener) {
        super();
        mlist = list;
...
//        public TextView time;
    ...
    @Override
    public GatewayPluginListRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                              int viewType) {
        // create a new view
        View convertView = LayoutInflater.from(context)
                .inflate(R.layout.listview_gateway_plugin_item, parent, false);
...
//        holder.time.setText(map.get("time"));
        initSwitch(holder.switchView,(String)map.get("status"));
