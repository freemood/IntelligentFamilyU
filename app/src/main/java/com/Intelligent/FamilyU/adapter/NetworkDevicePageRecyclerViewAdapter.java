...
public class NetworkDevicePageRecyclerViewAdapter extends RecyclerView.Adapter<NetworkDevicePageRecyclerViewAdapter.ViewHolder> {
    ...
    public NetworkDevicePageRecyclerViewAdapter(Context context, List<HashMap<String, Object>> list, OnItemClickListener onItemClickListener) {
        super();
        mlist = list;
    ...
    @Override
    public NetworkDevicePageRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                              int viewType) {
        // create a new view
        View convertView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.listview_network_device_paget_item, parent, false);
