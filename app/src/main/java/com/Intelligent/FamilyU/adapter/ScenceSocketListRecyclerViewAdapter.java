...
public class ScenceSocketListRecyclerViewAdapter extends RecyclerView.Adapter<ScenceSocketListRecyclerViewAdapter.ViewHolder> {
    ...
    public ScenceSocketListRecyclerViewAdapter(Context context, List<HashMap<String, Object>> list, OnItemClickListener onItemClickListener) {
        super();
        mlist = list;
    ...
    @Override
    public ScenceSocketListRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                             int viewType) {
        // create a new view
        View convertView = LayoutInflater.from(context)
                .inflate(R.layout.listview_scence_socket_list_item, parent, false);
