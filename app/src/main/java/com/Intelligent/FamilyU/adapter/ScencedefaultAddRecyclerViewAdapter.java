...
public class ScencedefaultAddRecyclerViewAdapter extends RecyclerView.Adapter<ScencedefaultAddRecyclerViewAdapter.ViewHolder> {
    ...
    public ScencedefaultAddRecyclerViewAdapter(Context context, List<HashMap<String, Object>> list, OnItemClickListener onItemClickListener) {
        super();
        mlist = list;
    ...
    @Override
    public ScencedefaultAddRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                             int viewType) {
        // create a new view
        View convertView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.listview_scence_add_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if ("add".equals(name)) {
            ...
            holder.imv.setImageResource(R.mipmap.scence_socket);
        }
