 ...
 *
 */
public class RemoteDirListBiz extends BaseBiz {

    /**
     */
    private final String API_PHONE_QUERY = "/api/remote-download-server/remote-download/save-path/";

    public void remoteListQuery(String mSerialNo,LifecycleProvider lifecycle, HttpRxCallback callback) {
        /**
         * 构建参数
         */
        ...
        callback.setParseHelper(new ParseHelper() {
            ...
            public Object[] parse(JsonElement jsonElement) {
                RemoteDirListBean bean = new Gson().fromJson(jsonElement, RemoteDirListBean.class);
