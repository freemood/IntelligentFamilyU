 ...
 *
 */
public class RemoteListBiz extends BaseBiz {

    /**
     */
    private final String API_PHONE_QUERY = "/api/remote-download-server/remote-download/task-list/";
    ...
    public void remoteListQuery(String mSerialNo,LifecycleProvider lifecycle, HttpRxCallback callback) {
        ...
        callback.setParseHelper(new ParseHelper() {
            ...
            public Object[] parse(JsonElement jsonElement) {
                RemoteListBean bean = new Gson().fromJson(jsonElement, RemoteListBean.class);
