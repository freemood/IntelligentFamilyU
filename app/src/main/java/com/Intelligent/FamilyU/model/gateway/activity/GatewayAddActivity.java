...
public class GatewayAddActivity extends BaseFragmentActivity {
    ...
    protected int getContentViewId() {
        return R.layout.activity_add_getawary_one;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.add_gateway:
                startActivity(new Intent(GatewayAddActivity.this, GatewayAddTwoActivity.class));
                break;
            case R.id.page_back:
                finish();
                break;
