...
/**解绑
 */
public class GatewayWifiInfoBiz extends BaseBiz {

    /**解绑
     */
    private final String BASE_URL = "/api/device-server/app-device/get-wifi/";

    public void gatewayWifiInfo(String serialNo, LifecycleProvider lifecycle, HttpRxCallback callback) {
        /**
         * 构建参数
         */
        ...
        callback.setParseHelper(new ParseHelper() {
            ...
            public Object[] parse(JsonElement jsonElement) {
                GatewayWifiInfoBean bean = new Gson().fromJson(jsonElement,GatewayWifiInfoBean.class);
