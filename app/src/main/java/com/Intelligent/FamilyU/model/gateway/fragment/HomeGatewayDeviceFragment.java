 ...
 * 网关设备
 */
public class HomeGatewayDeviceFragment extends BaseFragment implements IBaseView {
    ...
    protected View getContentView() {
        return LayoutInflater.from(mContext).inflate(R.layout.activity_more_device_list, null);
    }
    ...
    private void initAdapter() {
        nameStrings = new String[]{"网关1", "网关2"};
        messageStrings = new String[]{"IP：1929", "IP：1929"};
        timeStrings = new String[]{"21:09", "01:06"};
