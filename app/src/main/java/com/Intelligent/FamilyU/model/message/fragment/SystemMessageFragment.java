...
import com.Intelligent.FamilyU.adapter.SystemMessageListRecyclerViewAdapter;
 ...
 *
 */
public class SystemMessageFragment extends BaseFragment implements IMessageListView, IMessageOneReadView {
    @BindView(R.id.my_recycler_view)
    RecyclerView mRecyclerView;
    private RLoadingDialog mLoadingDialog;
    private SystemMessageListRecyclerViewAdapter adapter;
    ...
    private SystemMessageListRecyclerViewAdapter.OnItemClickListener mOnItemClickListener = new SystemMessageListRecyclerViewAdapter.OnItemClickListener() {
        @Override
    ...
    private void initAdapter() {
        ...
        adapter = new SystemMessageListRecyclerViewAdapter(mContext, mlist, mOnItemClickListener);
    ...
    public void showResult(MessageListBean bean) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (1 != messageBean.getType() && 2 != messageBean.getStatus()) {
