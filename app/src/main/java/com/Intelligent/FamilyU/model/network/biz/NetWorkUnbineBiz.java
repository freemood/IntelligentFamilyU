...
/**
 */
public class NetWorkUnbineBiz extends BaseBiz {

    /**
     */
    private final String BASE_URL = "/api/networking-server/app-networking/unbind-gateway/";

    public void unbindNetWork(String gatewaySn,String mac, LifecycleProvider lifecycle, HttpRxCallback callback) {
        /**
         * 构建参数
         */
        ...
        callback.setParseHelper(new ParseHelper() {
            ...
            public Object[] parse(JsonElement jsonElement) {
                NetWorkUnbindBean bean = new NetWorkUnbindBean();
