 ...
 * 网关设备
 */
public class HomeNetworkDeviceFragment extends BaseFragment implements IBaseView {
    ...
    private void initAdapter() {
        nameStrings = new String[]{"API", "API2"};
        messageStrings = new String[]{"BWM1257", "QWE279"};
