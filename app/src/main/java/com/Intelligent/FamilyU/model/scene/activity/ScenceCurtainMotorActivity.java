...
public class ScenceCurtainMotorActivity extends BaseFragmentActivity implements IScenceOperationView, IScenceOperatingView {
    ...
    protected int getContentViewId() {
        return R.layout.activity_scence_curtain_motor;
    }
    ...
    protected void initView() {
        ...
        titleTv.setText(R.string.home_scence_urtainc_motor);
