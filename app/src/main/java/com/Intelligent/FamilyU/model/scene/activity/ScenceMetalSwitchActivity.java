...
public class ScenceMetalSwitchActivity extends BaseFragmentActivity implements IScenceOperationView, IScenceOperatingView {
    ...
    protected int getContentViewId() {
        return R.layout.activity_scence_metal_switch;
    }
    ...
    protected void initView() {
        ...
        titleTv.setText(R.string.home_scence_metal_switch);
