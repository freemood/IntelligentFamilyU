...
public class HomeDeviceListBiz extends BaseBiz {
    /**
     * 查询家居
     */
    private final String API_LOGIN = "/api/home-server/app-home/device-list/";

    public void homeDeviceListQuery(String gatewaySn,LifecycleProvider lifecycle, HttpRxCallback callback) {
        /**
         * 构建参数
         */
