...
public class MediaFile {
    ...
    static {
        ...
        addFileType("M3U8", FILE_TYPE_3GPP2, "video/m3u8");
    ...
    //根据zip文件路径判断文件类型
    public static boolean isZipFileType(String path) {  //自己增加
        int lastDot = path.lastIndexOf(".");
        if (lastDot < 0)
            return false;
        String text = (path.substring(path.lastIndexOf(".") + 1)).toLowerCase();
